...
const DIALOGUES = {
  ...
  chief: {
    ...
    nodes: {
      ...
      briefing2: {
        speaker: "祥哥",
        text: "這案子拖超過一年，終於竣工了，接下來要先辦初驗。這次初驗你協助辦理，程序能跑就盡快跑一跑，後面的驗收也比較好接著辦，大家都輕鬆～",
        choices: [
          {
            label: "我了解，我先去工地看看狀況",
            next: null,
...
const ENDINGS = {
  ...
  missed: {
    title: "擦肩而過",
    text: "驗收順利結案，你也沒有多想。後來機關在其他查核中重新檢視這項工程，才發現部分給水管規格與契約要求不符。你這才想起當時角落那批下腳料……如果當初多問一句，或許能更早發現問題。",
  },
};
